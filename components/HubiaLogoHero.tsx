...
/**
 * HubiaLogoHero — Logo HŪBIA da Hubiaimg.
 * H + anello + 4 nodi + wordmark. Anelli orbitali rotanti, animazioni "union".
 */
...
export function HubiaLogoHero({ className = '' }: HubiaLogoHeroProps) {
  ...
  return (
    <div className={`inline-flex flex-col items-center gap-6 ${className}`}>
      {/* Orbital rings + icon container */}
      <div className="relative flex items-center justify-center">
        {/* Rotating rings around logo — union / spectacle */}
